    ...
    for k in (Slice):
        ...
        if k != 'PCT' and k != 'Label' and k != 'PLabel' and k!= 'bone_label':
            if A == 1:
                ...
                aladin = "reg_aladin.exe -ref D:\\MRES\\Label\\Catch%s\\Bone\\B%s.nii -flo D:\\MRES\\Label\\Catch%s\\bone_label.nii  -aff D:\MRES\Label\Catch%s\\txt\\%s.txt -rigOnly -ln 4 -lp 3 -%%%%v 100 -%%%%i 60 \n" % (Catch_num,k,Catch_num,Catch_num,k)
