...
clc
% read file from path
Contour_path = 'D:\MRES\Label\Catch009\contour.dcm';
% PLAN_nii1 = "D:\MRES\Label\Catch009\original\20200406";
PLAN_nii = 'D:\MRES\Label\Catch009\PCT.nii';
...
rtMask1 = createMask(rtContours, 4, referenceInfo);
rtMask2 = createMask(rtContours, 5, referenceInfo);
rtMaskT = createMask(rtContours, 20, referenceInfo);
