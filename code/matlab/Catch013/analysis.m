...
Data_path = "D:\MRES\Label\Catch013\";
...
% 
% format bank
% % v = VideoWriter('Catch011_subtraction','MPEG-4');
% v = VideoWriter('Catch011','MPEG-4');
% v.FrameRate = 6;
% sz = size(Test3);
% open(v)
% 
...
%    title_image = sprintf("Catch011  Z = %g no posi" ,j );
%    ylabel(sprintf("Date: 0528 0610 0617 0626"))
%    colormap('gray')
% %    colormap('hot')
%    axis square
% %  axis square
