...
Data_path = "D:\MRES\Label\Catch001\";

Scan1_path = '2-CT1.nii';
Scan2_path = '2-CT2.nii';
Scan3_path = '2-CT3.nii';
Scan4_path = '2-CT4.nii';
Scan5_path = '2-CT5.nii';
...
%% Video
% Test = cat(1,Scan1,Scan5);
% Test2 = cat(1,Scan3,Scan4);
% Test3 = cat(2,Test,Test2);

Test = cat(1,Scan1,Scan5-Scan1);
Test2 = cat(1,Scan3-Scan1,Scan4-Scan1);
Test3 = cat(2,Test,Test2);
% 
% 
format bank
v = VideoWriter('Catch001_subtraction','MPEG-4');
% v = VideoWriter('Catch001','MPEG-4');
v.FrameRate = 6;
sz = size(Test3);
open(v)
...
for j = 1:sz(3)
   ...
   title_image = sprintf("otherslices-Slice1\nCatch001  Z = %g Posi 1217" ,j );
%    title_image = sprintf("Catch001  Z = %g Posi 1217" ,j );
   ylabel(sprintf("Date: 1222 1223 1228 1229"))
   colormap('gray')
   axis square
%  axis square
   view([-90,-90])
