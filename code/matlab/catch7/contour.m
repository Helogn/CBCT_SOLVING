...
clc
% read file from path
path = 'D:\MRES\DATASETS\CATCH_0007\15\secondary\contour.dcm';
% PLAN_nii1 = "D:\MRES\Label\Catch009\original\20200406";
PLAN_nii = 'D:\MRES\Label\Catch007\PCT.nii';
...
Contour_path = 'D:\MRES\Label\Catch007\PCT.nii';
data = load_untouch_nii(Contour_path);

%%
B = int16(rtMask1);
data.img = B;
save_untouch_nii(data,'D:\MRES\Label\Catch007\Label1.nii')
